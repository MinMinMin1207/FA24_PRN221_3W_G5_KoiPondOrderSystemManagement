...
namespace Repository
{
    ...
    {
        protected FA24_PRN221_3W_G5_KoiPondOrderSystemManagementContext _context;
        ...
        public GenericRepository(FA24_PRN221_3W_G5_KoiPondOrderSystemManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<T>> GetAllAsync()            //Ky thuat bat bat dong bo, chay nhanh hon, chay dong thoi nhieu task cung luc
        {
