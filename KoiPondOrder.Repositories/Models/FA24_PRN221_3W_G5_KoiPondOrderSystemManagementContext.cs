...
public partial class FA24_PRN221_3W_G5_KoiPondOrderSystemManagementContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.HistoryId).HasName("PK__Customer__4D7B4ADD43C96EB1");
        ...
        {
            entity.HasKey(e => e.DesignId).HasName("PK__Designs__32B8E17F21FAD501");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF677D19B8A");
        ...
        {
            entity.HasKey(e => e.PondId).HasName("PK__Ponds__D18BF854F9B05B73");
            ...
            entity.HasOne(d => d.Design).WithMany(p => p.Ponds)
                ...
                .HasConstraintName("FK__Ponds__DesignID__534D60F1");

            entity.HasOne(d => d.DesignStaff).WithMany(p => p.PondDesignStaffs)
                .HasForeignKey(d => d.DesignStaffId)
                .HasConstraintName("FK__Ponds__DesignSta__5441852A");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Services__C51BB0EA247EC811");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC795B984C");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105347820495C").IsUnique();
